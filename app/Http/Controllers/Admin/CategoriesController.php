...
class CategoriesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'name'=>'required|max:255|min:3|unique:categories,name',
                ...
                'image'=>[
                    ...
                    'mimes:png,jpg',
                    // 'mimetype:image/png',
                    'dimensions:min_width:300,min_height=300,ratio=9/16'
                ],
        ...
        // $validator->failed(); //return roles that have problem
        // $validator->errors();//return errors massages 
        // $clean=$validator->validated(); //return right data input
